...
not_completely_empty = any(True if len(url) else False for url in urls)

if isProcessed and urls and not_completely_empty == True:
...
elif isProcessed and not_completely_empty == False:
